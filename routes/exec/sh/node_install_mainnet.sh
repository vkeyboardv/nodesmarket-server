...
echo -e "\033[0;32mStarting install Solana node mainnet...\033[0m"
SOLANA_DIR=/root/solana
mkdir -p $SOLANA_DIR
source /root/.bashrc
cp /root/mainnet-validator-keypair.json /root/solana/validator-keypair.json
cp /root/mainnet-vote-account-keypair.json /root/solana/vote-account-keypair.json
# cp /root/mainnet-withdrawer-keypair.json /root/solana/withdrawer-keypair.json
